...
export const useCapsuleStore = create<CapsuleStore>()(
    persist(
        ...
        {
            name: 'capsule-storage', // name of the item in the storage (must be unique)
            storage: {
                getItem: (name) => {
                    ...
                    return {
                        state: {
                        ...state,
                        unlockedCapsules: new Map(), // Don't persist unlocked content
                        },
                    }
                },
                setItem: (name, newValue) => {
                    const str = JSON.stringify({
                        state: {
                        ...newValue.state,
                        unlockedCapsules: undefined, // Don't persist unlocked content
                        },
                    })
